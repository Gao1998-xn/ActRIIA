...
**大鼠模型**：
- **脊柱融合模型**：rhBMP-2负载纳米颗粒的生物仿生移植物可促进大鼠脊柱融合中的骨再生 [149]。合成RARγ拮抗剂7C纳米颗粒联合低剂量BMP-2可增强大鼠脊柱融合模型中的骨再生 [141]。
- **股骨缺损模型**：BMP-2/7异源二聚体通过胶原-羟基磷灰石支架递送，在0.5 μg超低剂量下即可实现与20倍剂量BMP-2相当的骨折愈合效果 [145]。
- **颅骨缺损模型**：rhBMP-4在2.5或5 μg剂量下可显著增强局部骨形成 [146]。
- **复合骨缺损模型**：BMP-2剂量从2.5 μg增至10 μg可呈剂量依赖性改善再生骨体积和生物力学性能 [147]。

**兔模型**：
- **桡骨缺损**：空间控制递送低剂量rhBMP2（15 μg）从胶原涂层羟基磷灰石支架释放，在8周时获得比临床常用高剂量（76 μg）更大的骨体积和更高的骨密度 [144]。
- **颅骨缺损**：rhBMP-2负载β-TCP支架呈剂量依赖性骨诱导，较高剂量（10-20 μg）在2-8周内产生显著更多的新骨形成 [148]。

**新型递送策略**：
- **化学修饰mRNA（cmRNA）**：编码BMP-2的优化cmRNA可有效促进大段骨缺损的愈合，避免了rhBMP-2的副作用和高成本 [142]。
- **细胞渗透性BMP2（CP-BMP2）**：改良版BMP2具有改善的细胞渗透性，可促进骨再生，实现快速有效愈合 [140]。
- **工程化细胞外囊泡**：BMP2/BMP7工程化囊泡可通过自分泌BMP释放驱动SMAD磷酸化促进骨形成 [139]。

### 2.5 临床药物及结果

#### 2.5.1 INFUSE Bone Graft（rhBMP-2）

**产品信息**：INFUSE Bone Graft由Medtronic公司开发，活性成分为重组人BMP-2（rhBMP-2），负载于可吸收胶原海绵（ACS）载体上。它是目前唯一获FDA完全上市许可（PMA）的BMP类产品 [207, 209]。

**FDA批准历程**：
- **2002年**：首次通过PMA（P000058）批准，适应症为骨骼成熟患者的L4-S1单节段退行性椎间盘疾病（DDD）的脊柱融合，经开放前路或腹腔镜入路植入 [207]。
- **2004年**：PMA（P000054）批准用于急性开放性胫骨干骨折（经IM钉固定后14天内应用）[208]。
- **2007年**：批准用于上颌窦提升和拔牙窝缺损的局部牙槽嵴增量 [212]。
- **2009年**：扩展脊柱融合适应症至L2-S1单节段，可伴I度滑脱或I度后滑 [212]。

**临床效果**：
- **融合率**：系统综述显示rhBMP-2显著提高ALIF融合率（97.8% vs 88.2%）和PLF融合率（93.6% vs 83.1%），ALIF融合OR约7.08，PLF融合OR约3.06，但PLIF/TLIF融合率无显著改善 [160]。剂量-效应荟萃分析显示ALIF中BMP使融合率提高至96.9%（对照组79.1%，p<0.01），PLF在≥8.5 mg/节段时融合率95.2%（对照组75.3%，p<0.05）[155]。
- **疼痛与功能**：个体参与者数据荟萃分析显示rhBMP-2在24个月时影像学融合率提高12%，但未产生临床有意义的疼痛减轻（ODI/SF-36），且与早期术后疼痛增加相关（OR 1.78）[158]。
- **并发症**：基于人群的分析显示使用rhBMP-2的腰椎融合术与较高的术后并发症和再手术率相关 [156]。但在Medicare队列（8,609例PLIF患者）中，rhBMP-2与较低的总体术后并发症率相关（心脏、肺部、伤口/泌尿相关、感染），但假关节发生率较高 [157]。
- **颈椎应用警告**：2009年FDA发布公共卫生通知，警告rhBMP在颈椎应用中可导致危及生命的并发症（颈部和咽喉组织肿胀），强调rhBMP在颈椎的安全性和有效性尚未证实，未获FDA批准用于此适应症 [195]。

**大肠杆菌来源rhBMP-2**：韩国开发了注射用大肠杆菌来源rhBMP-2（E-rhBMP-2），在腰椎前路椎间融合（ALIF）和经椎间孔腰椎椎间融合（TLIF）中显示出高安全性和有效性，融合率良好且无不良术后并发症 [150, 154]。一项1019例PLIF回顾性分析显示rhBMP-2联合骨髓抽吸物可获低不融合率和改善的患者预后 [153]。

**成本与替代**：Map3细胞同种异体骨移植物在ALIF中显示与rhBMP-2等效的融合率，但成本更低 [152]。INFUSE和InductOs在骨再生方面有前景，但在成本、力学性能和可控生长因子递送方面仍需创新 [151]。

#### 2.5.2 BMP2衍生肽

OP5是一种低分子量BMP-2衍生成骨肽，具有强成骨潜力，可作为BMP-2临床骨再行的可行替代品，最小化BMP2相关不良效应 [14]。
...
BMP4是BMP家族中功能最广泛的成员之一，在胚胎发育、器官形成和成体代谢中均发挥关键作用 [57]。

**胚胎发育与模式建立**：
- BMP4在胚胎发育中具有双相、时间依赖性作用：早期胚外外胚叶（ExE）来源的BMP4驱动中内胚层分化和尿囊/原始生殖细胞（PGC）特化，而E7.5后胚胎来源的BMP4通过促进胚外中胚层向尿囊命运分化来限制PGC池大小 [58]。
- BMP4在两个不同胚胎环境中发挥作用：胚外外胚叶中的Bmp4对正常结节和原条形成至关重要，而胚胎Bmp4独立协调左右模式形成 [46]。
- BMP4可触发调控级联，在小鼠胚胎干细胞中激活Wnt3和Nodal，与Smad1/5和Tcf3/p-Smad2/3协同驱动中胚层增强子激活和心脏祖细胞基因（包括Eomes和T）表达，建立心肌中胚层形成并抑制神经命运 [44]。
- 在斑马鱼和人多能干细胞聚集体中，BMP4单独即可诱导腹-尾组织者，驱动腹-尾细胞命运特化和形态发生 [59]。

**眼发育**：BMP4对小鼠胚胎晶状体诱导至关重要——Bmp4敲除完全废除晶状体诱导，可通过在视泡施加BMP4蛋白挽救 [47]。BMP4信号是JNK驱动的细胞因子级联的一部分，诱导Pax2表达和视裂闭合 [45]。

**心脏发育**：BMP4通过抑制Vegfa水平促进流出道垫发育，防止先天性心脏病 [43]。Wt1通过转录调控Bmp4调节心外膜细胞形态和成熟，对胚胎心脏发育和成体心脏修复至关重要 [42]。

**骨/颅面/牙齿发育**：BMP4在骨、颅面和牙齿发育中发挥关键作用，其突变或缺失导致骨脆、颅面畸形和牙齿发育停滞 [52]。

**代谢调节**：BMP4在调节脂肪细胞分化、产热、葡萄糖稳态、胰岛素敏感性和脂质代谢中发挥关键作用，可能促成肥胖及相关代谢疾病 [50]。

**生殖系统**：BMP4通过SMAD依赖和非依赖通路抑制大鼠干细胞/祖Leydig细胞发育和再生 [51]。在卵巢中，BMP4在卵泡发育、多囊卵巢综合征（PCOS）和卵巢癌中发挥重要作用 [53]。

**肺纤维化**：BMP4过表达可通过调节细胞衰老和线粒体自噬减少肺成纤维细胞活化和衰老，可能成为肺纤维化的有效治疗策略 [55]。

**滋养层分化**：BMP4信号促进多能细胞中滋养层的出现，可有效驱动引物或初始多能干细胞向滋养层谱系分化 [56]。

### 3.2 基因敲除动物表型

**Bmp4完全敲除小鼠**：Bmp4基因敲除小鼠在胚胎早期死亡，主要表现为：
- **原条和结节形成缺陷**：胚外外胚叶中的Bmp4对结节和原条形成至关重要 [46]。
- **左右模式紊乱**：胚胎Bmp4独立协调左右不对称模式形成 [46]。
- **晶状体诱导失败**：Bmp4敲除完全废除晶状体诱导 [47]。
- **心脏流出道缺陷**：BMP信号通过抑制Vegfa促进流出道垫发育，缺失导致先天性心脏病 [43]。

**前域加工突变**：
- BMP4前域磷酸化位点突变（S91C和E93G）降低BMP4同源二聚体活性，导致未加工BMP4积累，引起严重发育缺陷和高产前致死率，包括眼和心脏异常 [48]。
- BMP4前域两个位点的同时切割（而非有序切割）显著降低成熟BMP4水平，导致胚胎致死伴眼和心脏发育紊乱 [49]。

**人类突变关联**：BMP4新发突变可能 predispose 人类先天性心脏病，有助于改善产前遗传咨询和个体化治疗 [41]。

### 3.3 阻断后的作用

#### 3.3.1 基因敲除/敲低

Bmp4完全敲除导致胚胎早期致死（见3.2节），表明BMP4在胚胎发育中不可替代。BMP7在哺乳动物胚胎发生中主要以与BMP2或BMP4的异源二聚体形式发挥功能，这可能解释为何BMP4或BMP7的突变导致相似的先天性缺陷 [3]。

#### 3.3.2 药理阻断

BMP4信号可被多种胞外拮抗剂阻断：
- **Noggin、Chordin、Follistatin、Gremlin**：这些胞外结合蛋白选择性调节BMP依赖的卵巢类固醇生成变化 [60]。BMP拮抗剂通过结合亲和力、局部浓度梯度和基质螯合的精密调控来调节BMP信号强度 [66]。
- **Chordin形态发生通路**：BMP信号和背-腹模式形成由BMP与拮抗剂（Chordin、Noggin、Follistatin）之间的定量平衡塑造，通过相互作用和差异扩散网络实现 [69]。

#### 3.3.3 正面影响（治疗潜力）

- **肺纤维化治疗**：BMP4过表达可减少肺成纤维细胞活化和衰老，可能成为肺纤维化的有效治疗 [55]。
- **代谢疾病**：BMP4在脂肪产热和葡萄糖稳态中的调节作用提示其作为代谢疾病治疗靶点的潜力 [50]。
- **炎症性肠病**：BMP和BMP拮抗剂在炎症性肠病中发挥重要作用，为新型治疗策略提供可能 [62]。

#### 3.3.4 负面影响（副作用/毒性）

- **胚胎致死**：Bmp4完全敲除导致胚胎早期死亡，伴随多器官发育缺陷。
- **前域加工异常**：BMP4前域磷酸化或切割异常导致严重发育缺陷和产前致死 [48, 49]。
- **骨转移**：BMP通路抑制剂LDN-193189在小鼠中显著增强骨转移发展 [75]。
- **肌生成抑制信号脱靶**：Dorsomorphin和LDN-193189可通过结合ActRIIA受体和ALK4抑制肌生成抑制素（GDF8）信号，脱靶促进肌母细胞分化 [80]。

### 3.4 动物模型及给药方案

**大鼠颅骨缺损模型**：rhBMP-4在2.5或5 μg剂量下，以可吸收胶原海绵（ACS）或β-TCP为载体，可显著增强局部骨形成。ACS在8周时产生更高骨密度，β-TCP组显示更大增强区域。在测试范围内无明显剂量依赖效应 [146]。

**斑马鱼模型**：BMP4在适当剂量下可诱导腹-尾组织者，驱动腹-尾细胞命运特化和形态发生，形成次级后轴 [59]。

**小鼠胚胎干细胞模型**：BMP4触发调控级联，通过激活Wnt3和Nodal驱动心肌中胚层形成 [44]。

**人多能干细胞模型**：BMP4可有效驱动引物或初始多能干细胞向滋养层谱系分化，实现滋养层干细胞的可重复高效衍生 [56]。

### 3.5 临床药物及结果

目前尚无以BMP4为活性成分的FDA获批药物。BMP4的临床转化主要处于临床前和早期探索阶段：

- **骨再生**：rhBMP-4在大鼠颅骨缺损模型中显示成骨效果，但尚未进入临床试验 [146]。
- **肺纤维化**：BMP4过表达的抗纤维化策略尚处于临床前研究阶段 [55]。
- **代谢疾病**：BMP4在代谢调节中的作用为肥胖和糖尿病提供了潜在治疗靶点，但距离临床应用尚远 [50]。
...
**肾脏发育与保护**：
- BMP7是肾脏发生的关键诱导因子，对维持和扩增肾单位祖细胞池、决定出生时肾单位数量至关重要 [6, 8]。BMP7通过抑制过早分化和支持未分化肾脏祖细胞的维持来决定出生肾单位数量 [6]。
- BMP7驱动近端小管扩张并决定发育中肾脏的肾单位数量 [10]。
- BMP7作为内源性肾保护因子，其抗炎、抗纤维化和再生效应在急性和慢性肾损伤中随衰老和慢性损伤而下降 [36, 39]。
- 外源性BMP7或恢复BMP7活性可减轻急性肾损伤（AKI）和慢性肾病（CKD）中的炎症、纤维化和功能恶化 [32, 36]。
- BMP7给药通过抑制炎症、改善肾血流和减少纤维化提供肾脏疾病中的组织保护 [32]。

**骨形成**：
- BMP7通过Wnt/β-连环蛋白信号在骨细胞中的激活，促进骨髓间充质干细胞的成骨分化 [31]。
- BMP7/OP-1通过阻止持续NFATc1和c-Fos活性、维持MafB表达来抑制人单核细胞向破骨细胞分化，从而减少破骨细胞生成 [37]。

**心脏保护**：BMP7在心脏疾病中通过减少炎症和促进干细胞分化显示出治疗意义，可能改善心功能 [35]。

**细胞外基质靶向**：BMP7以前域复合物形式分泌，特异性结合微纤维蛋白-1（fibrillin-1），将BMP7浓缩在肾囊和皮肤等组织的储存位点，支持器官发育和骨形成中的BMP7驱动信号 [38]。

**异源二聚体功能**：BMP7在哺乳动物胚胎发生中主要以与BMP2或BMP4的异源二聚体形式发挥功能，这可能解释为何BMP4或BMP7的突变导致相似的先天性缺陷 [3]。

### 4.2 基因敲除动物表型

**Bmp7完全敲除小鼠**：Bmp7基因敲除小鼠出生后不久死亡，主要表现为 [7, 9]：
- **肾脏严重发育不全**：肾脏发育迟缓伴肾发育不良，肾单位生成缺陷，肾小球几乎完全缺失 [7, 8]。
- **肾单位数量急剧减少**：BMP7敲除小鼠肾单位数量降至正常的约十分之一 [10]。
- **眼发育缺陷**：无眼症（anophthalmia）[7, 9]。
- **骨骼模式形成缺陷**：肋骨笼、颅骨和后肢发育的特异性破坏，包括后肢多趾畸形 [7, 8]。

**条件性敲除**：从肢体骨骼中条件性删除BMP7不影响骨形成或骨折修复，提示成体骨中存在的其他BMP可补偿BMP7的缺失 [5]。

**系统性条件性敲除**：在肾发生开始后系统性条件性敲除Bmp7会加速分化和增加祖细胞丢失，减少肾单位赋值 [6]。

**人类突变关联**：BMP7突变与可变的眼、脑、耳、腭和骨骼异常相关，表明其在人类眼发育中的重要性 [4]。

### 4.3 阻断后的作用

#### 4.3.1 基因敲除/敲低

Bmp7完全敲除导致出生后死亡，伴严重肾脏、眼和骨骼缺陷（见4.2节）。条件性敲除研究表明BMP7在成体骨中的缺失可被其他BMP补偿 [5]，但在肾脏发育中不可替代。

#### 4.3.2 药理阻断

BMP7信号可被USAG-1（Uterine Sensitization-Associated Gene-1）等胞内拮抗剂调节。Rosuvastatin可通过上调HOXA13抑制USAG-1、增强BMP-7信号来减轻肾间质纤维化 [126]。BMP7在梗阻性肾病中的保护作用主要通过非经典BMP信号和CCN2（CTGF）下调介导 [127]。

#### 4.3.3 正面影响（治疗潜力）

- **肾脏疾病**：BMP7是肾脏疾病治疗的重要候选分子。工程化长效BMP7（HSA-BMP7，与人血清白蛋白融合）血浆半衰期显著延长（约为BMP7的10倍），每周给药即可显著减轻小鼠肾损伤模型中的肾纤维化 [33]。
- **抗纤维化**：微胶束化蛋白转导结构域-BMP7（mPTD-BMP7）可有效阻断肾纤维化，通过抑制TGF-β介导的上皮-间质转化 [121]。
- **新型BMP-7受体激动剂**：苯并咪唑类BMP-7受体激动剂可调节TGF-β驱动的EMT和减少CKD模型中的纤维化 [128]。
- **骨/软骨修复**：BMP7与BMP2在软骨和骨修复中通过刺激间充质干细胞分化显示出再生医学和组织工程潜力 [34]。

#### 4.3.4 负面影响（副作用/毒性）

- **出生后致死**：Bmp7完全敲除小鼠出生后不久因肾脏严重发育不全而死亡。
- **多器官缺陷**：除肾脏外，还伴发无眼症和骨骼畸形。
- **递送挑战**：重组BMP7的短半衰期和递送效率是临床转化的主要障碍，需通过融合蛋白、纳米载体或细胞外囊泡等策略改进 [33, 139]。

### 4.4 动物模型及给药方案

**小鼠肾损伤模型**：
- HSA-BMP7融合蛋白：每周给药，显著减轻肾纤维化，半衰期与白蛋白相当 [33]。
- mPTD-BMP7：微胶束化递送，有效阻断TGF-β介导的EMT和肾纤维化 [121]。
- UUO（单侧输尿管梗阻）模型：BMP7治疗减少CCN2表达，减轻肾损伤、纤维化和巨噬细胞浸润 [127]。
- 缺血-再灌注模型：Rosuvastatin通过HOXA13-USAG1-BMP7通路减轻肾小管间质纤维化，4周治疗后减少纤维化标志物 [126]。

**骨再生模型**：
- BMP2/BMP7工程化细胞外囊泡：通过自分泌BMP释放驱动SMAD磷酸化促进骨形成 [139]。
- BMP-2/7异源二聚体：在胶原-羟基磷灰石支架上以0.5 μg超低剂量递送，在大鼠股骨缺损模型中实现与20倍剂量BMP-2相当的骨折愈合 [145]。
- 纳米纤维3D支架：可分别控制BMP-7和FGF-2释放，通过增强干细胞迁移、增殖和血管生成优化骨再生 [143]。

### 4.5 临床药物及结果

#### 4.5.1 OP-1 Implant / OP-1 Putty（rhBMP-7）

**产品信息**：OP-1 Implant和OP-1 Putty由Stryker Biotech开发，活性成分为重组人BMP-7（rhBMP-7/OP-1），负载于胶原载体上 [191]。

**FDA批准状态**：
- **OP-1 Implant**：2001年10月17日通过人道主义器械豁免（HDE，H010002）批准，适应症为作为自体骨移植替代品用于使用自体骨移植不可行且替代治疗已失败的顽固性长骨不连接 [191]。
- **OP-1 Putty**：2004年4月7日通过HDE（H020008）批准，适应症为自体骨和/或骨髓采集不可行或不能促进融合且至少有以下一项不利因素（骨质疏松、糖尿病或尼古丁使用）的患者中有症状的后外侧（横突间）腰椎假关节的修复 [194]。

**重要说明**：HDE并非完全PMA批准，而是针对罕见病/罕见用途的人道主义器械豁免，要求在使用机构审查委员会（IRB）监督下使用。OP-1产品因疗效证据不一致，始终未获得完全PMA批准 [167, 195]。

**临床效果**：
- **长骨不连接**：一项84例长骨不连接队列研究中，约81%在无需进一步手术的情况下愈合，感染是唯一显著降低融合率的因素，既往手术失败次数越多则愈合时间越长 [171]。意大利多中心观察性研究显示9个月时影像学融合率为78.6%（仅Osigraft组82.4%），治疗失败率19.5%，无不良事件报告 [168]。
- **后外侧腰椎融合**：多中心随机试验中，OP-1 rhBMP-7未能证明不劣于自体髂骨移植——1年总体成功率40% vs 54%，融合率54% vs 74%（OP-1 vs 自体骨，P=0.03）[170]。
- **骨不连接辅助治疗**：自体骨移植联合rhBMP未能显著改善长骨不连接愈合或疼痛减轻，但肢体功能良好 [164]。在无菌性肱骨、股骨和胫骨干不连接的翻修手术中，添加rhBMP-7未改善长期临床或影像学结果 [172]。
- **病理骨折模型**：在放疗和骨膜剥离诱导的不连接大鼠模型中，OP-1未能改善骨折愈合，治疗组联合率仅2% vs 对照组97% [169]。
- **总体评价**：BMP-7治疗骨折不连接的疗效与骨移植相当但并发症较少 [162]；但BMP在骨不连接和骨折结果中的证据并不一致 [163]。

**安全性**：2009年FDA公共卫生通知指出，rhBMP（包括INFUSE和OP-1 Putty）在颈椎应用中可导致危及生命的并发症（颈部和咽喉组织肿胀），强调rhBMP在颈椎的安全性和有效性尚未证实且未获FDA批准用于此用途 [195]。2011年HDE补充申请更新了标签以纳入与抗体交叉反应相关的额外风险 [193]。

#### 4.5.2 BMP7在肾脏疾病的临床转化

BMP7在CKD和AKI中的治疗潜力已在大量动物模型中得到验证，但临床转化面临重大挑战：
- 重组BMP7的短半衰期和递送效率限制了其临床应用 [33]。
- 长效BMP7融合蛋白（HSA-BMP7）和新型BMP-7受体激动剂（苯并咪唑类）正在临床前开发中 [33, 128]。
- BMP7在CKD纤维化治疗管线中被列为潜在治疗靶点，但尚未进入临床试验阶段 [122, 125]。
...
**铁代谢/肝铁调素调节**：
- BMP9是肝脏铁调素（hepcidin）表达的关键调节因子。肝铁调素是机体铁稳态的主调节因子，BMP9信号通过SMAD通路调节肝铁调素表达，从而控制系统铁代谢 [95, 96, 98, 99]。
- BMP信号在体内调节系统铁平衡：给予BMP-2可增加肝脏铁调素表达并降低血清铁，而可溶性血幼素（HJV.Fc）阻断BMP诱导的铁调素，增加膜铁转运蛋白和血清铁 [100]。
- 铁调素产生随肝脏BMP9（GDF2）信号增加而增加，作为铁感应调节的一部分 [99]。
- 骨源性C端FGF23切割肽通过减少BMP诱导的肝脏铁调素分泌来增加急性炎症中的铁可用性 [94]。

**肝脏生物学**：
- BMP9在出生后小鼠肝脏和肺部高表达，可能解释其对干细胞分化、血管生成、肿瘤生长和代谢的多效性 [97]。
- BMP9/GDF2和BMP10协调肝脏细胞间通讯以维持肝脏健康，肝星状细胞（HSC）通过产生GDF2和BMP10促进分化和维持器官身份 [92]。
- 在正常肝细胞中BMP9促进抗增殖/上皮稳定化，但在肝细胞癌细胞中增强生长和迁移特性 [101]。
- BMP9-ID1信号促进EpCAM阳性肝细胞癌的肿瘤干细胞特性 [74]。

**血管/淋巴管生物学**：
- BMP9控制淋巴管成熟和瓣膜形成 [110]。
- BMP9对淋巴管特异性内皮细胞扩增具有双相效应：低浓度促进淋巴管特异性内皮细胞扩增，高浓度促进LYVE-1阴性内皮细胞形成 [114]。
- BMP9在乳腺癌小鼠模型中作为肿瘤生长、血管正常化和转移的静息因子发挥作用 [111]。

### 5.2 基因敲除动物表型

**Bmp9敲除小鼠**：
- **淋巴管缺陷**：Bmp9敲除小鼠显示异常淋巴管——集合淋巴管扩张和瓣膜数量减少，导致淋巴引流受损 [116]。眼淋巴管缺陷（结膜淋巴管干扩张和淋巴管瓣膜减少）但对眼内压无功能影响 [120]。
- **血管缺陷**：Bmp9敲除小鼠显示轻度血管重塑，表现为平滑肌细胞覆盖减少 [112]。视网膜血管化由BMP10冗余性正常化 [116]。
- **动脉导管**：Bmp9/Bmp10双重干扰影响动脉导管闭合 [116]。
- **动静脉网络**：BMP10独立于BMP9对正常动静脉网络发育至关重要，其缺失导致视网膜动静脉畸形（AVM）[104]。
- **他莫昔芬敏感性**：Bmp9敲除小鼠对他莫昔芬异常敏感，提示在研究BMP9敲除小鼠及心血管和肺疾病模型时需谨慎 [112]。

**人类GDF2突变**：
- GDF2突变在肺动脉高压（PAH）患者中导致循环BMP9和BMP10水平降低，支持增强BMP9或BMP10信号的治疗策略 [115]。
- GDF2和BMP10致病变异在PAH患者中罕见，偶尔与先天性心脏病相关 [177]。
- GDF2（BMP9）和BMP10变异的功能和分子表征显示，功能丧失变异通常破坏蛋白加工并可损害BMP10分泌 [179]。

### 5.3 阻断后的作用

#### 5.3.1 基因敲除/敲低

Bmp9敲除小鼠可存活但显示淋巴管和血管缺陷（见5.2节），表明BMP9对出生后发育非绝对必需，但对血管和淋巴管稳态重要。BMP10可在部分功能上补偿BMP9缺失 [116]。

#### 5.3.2 药理阻断

- **联合BMP9/BMP10抑制**：通过ACTRIIB-Fc或ALK1-Fc联合抑制BMP9和BMP10在易感小鼠中强烈模拟遗传性出血性毛细血管扩张症（HHT）表型，突出了在潜在肺动脉高压治疗中AVM的风险 [173]。
- **Sotatercept（ActRIIA-Fc）**：在PAH患者中，sotatercept并未重新平衡或增加BMPR-II通路信号，反而导致BMP信号减少，可能由于循环BMP9和BMP10的耗竭 [180]。

#### 5.3.3 正面影响（治疗潜力）

- **贫血治疗**：BMP9信号阻断可降低铁调素水平，增加铁可用性，为铁调素过载相关贫血（如慢性病贫血、β-地中海贫血）提供治疗策略 [94, 100]。
- **PAH治疗**：GDF2突变导致BMP9/BMP10水平降低，支持增强BMP9或BMP10信号的治疗策略 [115]。
- **肿瘤血管正常化**：激活BMP9通路可能是肿瘤血管正常化的新策略 [111]。

#### 5.3.4 负面影响（副作用/毒性）

- **HHT样表型**：联合BMP9/BMP10抑制可诱发HHT样表型，包括动静脉畸形 [173]。
- **铁过载风险**：BMP9信号过度阻断可能通过抑制铁调素导致铁过载。
- **BMP信号耗竭**：sotatercept作为配体陷阱可能耗竭循环BMP9和BMP10， paradoxically减少而非增加BMP信号 [180]。

### 5.4 动物模型及给药方案

**Bmp9敲除小鼠**：用于研究淋巴管成熟、瓣膜形成和血管重塑 [110, 112, 116, 120]。

**小鼠胚胎干细胞分化模型**：BMP9对淋巴管特异性内皮细胞扩增呈双相效应 [114]。

**乳腺癌小鼠模型**：BMP9作为肿瘤生长和转移的静息因子 [111]。

**铁代谢模型**：BMP信号在体内调节系统铁平衡，BMP配体给药可调节铁调素和血清铁 [100]。
...
- Sotatercept是激活素IIA型受体-Fc（ActRIIA-Fc）融合蛋白，作为配体陷阱清除过量激活素A和其他TGF-β超家族配体 [184, 185]。
- 2024年3月26日获FDA批准（商品名Winrevair），适应症为成人PAH（WHO Group 1），以增加运动能力、改善WHO功能分级并降低临床恶化事件风险 [183, 188]。
- 推荐起始剂量0.3 mg/kg皮下注射，目标剂量0.7 mg/kg每3周一次 [184]。
- 机制上，sotatercept通过重新平衡促增殖（ActRIIA/Smad2/3介导）和抗增殖（BMPRII/Smad1/5/8介导）信号来调节血管增殖 [185, 186]。但最新研究发现sotatercept实际上可能通过耗竭循环BMP9和BMP10导致BMP信号减少 [180]。
- STELLAR III期试验显示sotatercept显著改善PAH患者的运动能力和临床结果 [187]。
- 在HHT合并严重PAH的患者中，sotatercept显著改善运动能力和生活质量，但伴随鼻出血频率增加和血红蛋白升高 [181]。

**PAH中的GDF2/BMP10变异**：GDF2和BMP10致病变异的鉴定为PAH的精准医学提供了新方向，增强BMP9/BMP10信号被认为是潜在治疗策略 [115, 177, 179]。
...
**心脏发育**：
- BMP10对维持妊娠中期心脏生长至关重要。BMP10缺失导致妊娠中期（E9.0-E9.5）心肌细胞增殖显著减少，伴p57Kip2异位上调和关键心肌生成因子（如Nkx2.5、MEF2C）维持受损，导致正常心脏生长和心室成熟失败 [87]。
- BMP10通过双重激活SMAD介导和STAT3介导的通路保护心功能，促进心肌细胞存活并抑制心脏纤维化 [82]。
- BMP10信号促进人多能干细胞来源心血管祖细胞向内膜细胞发育 [81]。
- BMP10是心室内小梁形成的关键信号分子，Notch信号对心室腔发育至关重要，而BMP10直接促进心室小梁形成中的心肌细胞增殖——外源BMP10可挽救RBPJk突变体中的心肌增殖缺陷 [90]。
- 内皮Tie2在心室腔形成中支持内膜细胞增殖和出芽，并通过抑制小梁心肌细胞中的视黄酸信号防止过度小梁化 [86]。

**血管生物学**：
- BMP10介导的ALK1信号对血管发育和维持持续必需，在胚胎后血管维持中发挥独特作用，可作为HHT2相关高输出心力衰竭的模型 [84]。
- BMP10的前域结合形式在成体内皮细胞上具有完全生物活性，可能作为内皮选择性BMP配体在BMP9/10信号丧失的特征性疾病中具有治疗潜力 [103]。
- BMP10独立于BMP9对正常动静脉网络发育至关重要，其缺失导致视网膜AVM，提示它是HHT病理中最相关的生理配体 [104]。
- Furin是BMP10的主要加工酶，Furin依赖的BMP10成熟对心脏发育至关重要 [105]。

**代谢/糖尿病关联**：BMP10在心脏发育、内皮功能和糖尿病中发挥作用，可能增强对糖尿病心肌病发病机制的理解 [83]。

**心力衰竭生物标志物**：在心力衰竭患者中，BMP10、ALK1和Endoglin的较高水平与更严重的症状、更高的房颤风险和更差的预后相关 [85]。

### 6.2 基因敲除动物表型

**Bmp10完全敲除小鼠**：
- **妊娠中期致死**：BMP10敲除小鼠在妊娠中期（约E9.5-E10.5）死亡 [87]。
- **心肌细胞增殖缺陷**：心肌细胞增殖在E9.0-E9.5显著减少，伴p57Kip2异位上调 [87]。
- **心室成熟失败**：正常心脏生长和心室腔成熟失败，关键心肌生成因子维持受损 [87]。
- **小梁形成缺陷**：BMP10是心室内小梁形成的关键促进因子 [90]。

**血管特异性表型**：
- BMP10缺失导致视网膜AVM [104]。
- BMP10介导的ALK1信号缺失影响胚胎后血管维持 [84]。

**人类变异关联**：
- 外显子测序在多发左侧心脏缺陷家系中鉴定出BMP10等候选变异，支持其在心脏发育中的疾病基因作用 [88]。
- BMP10功能丧失变异（Gln56*）在人类扩张型心肌病（DCM）家系中被鉴定，该突变体未能反式激活NKX2.5和TBX20，支持BMP10单倍体不足作为疾病贡献因素 [108]。
...
- **联合BMP9/BMP10抑制**：通过ACTRIIB-Fc或ALK1-Fc联合抑制BMP9和BMP10在易感小鼠中强烈模拟HHT表型 [173]。
- **Sotatercept**：作为ActRIIA-Fc融合蛋白，可能通过耗竭循环BMP9和BMP10间接影响BMP10信号 [180]。

#### 6.3.3 正面影响（治疗潜力）

- **HHT治疗**：BMP10的前域结合形式在成体具有完全生物活性，可作为内皮选择性BMP配体在BMP9/10信号丧失的疾病（如HHT）中具有治疗潜力 [103]。
- **心肌保护**：BMP10通过双重激活SMAD和STAT3通路保护心功能，可能为心力衰竭治疗提供策略 [82]。
- **心肌再生**：BMP10促进心肌细胞增殖的特性提示其在心肌再生中的潜力。

#### 6.3.4 负面影响（副作用/毒性）

- **胚胎致死**：Bmp10完全敲除导致妊娠中期胚胎死亡。
- **HHT样表型**：联合BMP9/BMP10抑制可诱发HHT样动静脉畸形 [173]。
- **心力衰竭预后标志**：BMP10水平升高在心力衰竭患者中与更差的预后相关 [85]，提示BMP10的过度信号也可能有害。

### 6.4 动物模型及给药方案

**Bmp10敲除小鼠**：用于研究心脏发育、小梁形成和血管维持 [84, 87, 104]。

**人多能干细胞模型**：BMP10信号促进人多能干细胞来源心血管祖细胞向内膜细胞发育，为心脏再生提供体外模型 [81]。

**HHT小鼠模型**：BMP10介导的ALK1信号缺失作为HHT2相关高输出心力衰竭的模型 [84]。

**大鼠PAH模型**：Sotatercept类似物在PAH大鼠模型中减少炎症、抑制内皮和平滑肌细胞增殖，导致血管壁变薄、右心室重塑部分逆转和血流动力学改善 [185]。

### 6.5 临床药物及结果

目前尚无以BMP10为活性成分的直接获批药物。BMP10的临床转化主要通过间接途径：

**Sotatercept（Winrevair）**：虽然sotatercept的主要靶点是激活素A，但作为ActRIIA-Fc配体陷阱，它也结合BMP9和BMP10等其他TGF-β超家族配体。最新研究表明sotatercept可能通过耗竭循环BMP9和BMP10导致BMP信号减少 [180]，这对其在PAH中的治疗机制提出了新的理解。

**HHT治疗方向**：BMP10的前域结合形式作为内皮选择性BMP配体的治疗潜力正在探索中 [103]，但尚未进入临床试验。

**扩张型心肌病**：BMP10功能丧失变异与人类DCM相关 [108]，但针对BMP10的特异性治疗尚未开发。
...
Goldman等（2008）首次系统分析了Bmp2与Bmp4之间的遗传互作 [224]。由于Bmp2⁻/⁻和Bmp4⁻/⁻纯合子均在胚胎早期致死，研究者利用杂合子组合检测剂量敏感效应：

- **Bmp2⁺/⁻;Bmp4⁺/⁻双杂合子**：存活率显著低于孟德尔预期，部分胚胎出现心脏流出道分隔缺陷、腹侧体壁闭合不全及眼发育异常。单杂合子（Bmp2⁺/⁻或Bmp4⁺/⁻）表型基本正常，表明两者在多个器官发育中共享功能，且存在剂量阈值效应 [224]。
- **Bmp2⁻/⁻;Bmp4⁺/⁻复合突变体**：胚胎致死，表型比Bmp2⁻/⁻单敲更严重，心脏发育缺陷加剧，包括房室管分隔异常和心室肌增殖受损 [224]。
- **Bmp2⁺/⁻;Bmp4⁻/⁻复合突变体**：同样胚胎致死，中胚层形成和体节发育严重受损 [224]。

Uchimura等（2009）进一步证实Bmp2和Bmp4在心脏功能发育中的协同作用：双杂合子小鼠出生后出现心功能异常，包括射血分数降低和心律失常，表明BMP2/BMP4的剂量不仅影响胚胎期心脏形态发生，也影响出生后心脏功能维持 [237]。

#### 7.1.2 肢芽间充质条件性双敲除

Bandyopadhyay等（2006）利用Prx1-Cre在肢芽间充质中条件性敲除Bmp2和Bmp4，系统分析了不同剂量组合对肢体骨骼发育的影响 [241]：
...
**关键发现**：
- **阈值效应**：BMP信号需达到阈值才能启动软骨发生。Bmp2/Bmp4双敲前肢后部指原基无法形成Sox9⁺软骨凝聚体，但Msx2仍表达，表明后部间充质存活但未能启动软骨分化 [241]。
- **软骨发生 vs 骨发生分离**：一旦软骨凝聚体形成，软骨分化（Col II、Col X表达）在Bmp2/Bmp4双敲或Bmp2/Bmp7双敲中均可正常进行。但**骨发生严重受损**：Bmp2/Bmp4双敲小鼠出生后3周仍无骨髓腔、小梁骨或皮质骨形成，骨祖细胞表达Col I和Runx2但**Osterix表达缺失**，无法分化为成熟成骨细胞 [241]。
- **BMP5/6/7不能完全补偿**：尽管BMP5、BMP6、BMP7在肢芽中表达且可利用相同受体，但它们无法补偿Bmp2/Bmp4联合缺失对骨发生的贡献，表明BMP2/BMP4在成骨细胞分化中具有不可替代的作用 [241]。

### 7.2 BMP4/BMP7双敲除与复合突变

#### 7.2.1 骨骼发育

Katagiri等（1998）分析了Bmp4/Bmp7双杂合子小鼠的骨骼表型 [223]：

- **Bmp4⁺/⁻单杂合子**：轻度骨骼异常，包括近端指骨缩短和胸骨微小缺陷。
- **Bmp7⁻/⁻纯合子**：出生后早期死亡，多趾和肾脏发育不全。
- **Bmp4⁺/⁻;Bmp7⁺/⁻双杂合子**：出现单杂合子不表现的缺陷，包括**肋笼腹侧异常**和**远端肢体畸形**，外显率约60%。这表明BMP4和BMP7在骨骼发育中具有协同作用，且单拷贝剂量不足以维持正常骨骼形态 [223]。

#### 7.2.2 尾部体形成与 sirenomelia 模型

Suzuki等（2012）揭示了Bmp4和Bmp7在尾部体（caudal body）形成中的遗传互作 [227]：

- **Isl1-Cre;Bmp4^flox/flox条件敲除**（Bmp4在Islet1表达域中敲除）：表现**完整的sirenomelia（美人鱼综合征）表型**——后肢融合（59%为III型：腓骨缺失；36%为I型：腓骨异常内移；5%为V型：腓骨缺失伴股骨融合）、膀胱发育不全、肾脏发育不良、肛门狭窄和外生殖器发育不良 [227]。
- **Bmp7⁻/⁻单敲**：不表现sirenomelia表型，仅有肾脏发育不良 [227]。
- **Hoxa3-Cre;Bmp4^flox/+;Bmp7^flox/flox复合突变体**（Bmp4杂合+Bmp7纯合敲除）：表现**后肢融合、膀胱缺失和肛门狭窄**，与Bmp4条件敲除表型一致。这证明Bmp4是尾部体形成的主要BMP配体，Bmp7的丢失加剧了Bmp4剂量不足的表型，两者间存在遗传互作 [227]。

#### 7.2.3 BMP7异二聚体功能的关键证据

Kim等（2019）通过Bmp7^R-GFlag敲入小鼠（该突变阻止BMP7前体蛋白的蛋白水解激活，从而消除BMP7同源二聚体和所有与BMP7的异源二聚体）提供了BMP7以异二聚体形式发挥主要功能的直接遗传证据 [222]：

- **Bmp7^null/null（常规敲除）**：出生后存活，但有肾脏和眼缺陷。
- **Bmp7^R-GFlag/R-GFlag（异二聚体失活）**：**胚胎致死**，广泛降低BMP活性，表型远比常规敲除严重。这表明BMP7在体内主要通过BMP2/7或BMP4/7异二聚体发挥作用，而非同源二聚体 [222]。
- **Bmp7^R-GFlag/+;Bmp2^null/+复合杂合子**：**胚胎致死**，表现为腹侧体壁闭合缺陷和/或心脏异常 [222]。
- **Bmp7^R-GFlag/+;Bmp4^null/+复合杂合子**：**胚胎致死**，同样表现为腹侧体壁闭合和心脏缺陷 [222]。

这些结果解释了为何BMP4和BMP7突变在人类中导致相似的先天缺陷谱——因为它们在体内主要以BMP4/7异二聚体形式共同发挥作用 [222]。共免疫沉淀实验进一步证实了内源性BMP4/7异二聚体的存在 [222]。

Neugebauer等（2015）补充了生化机制：BMP4前体结构域是生成稳定BMP4/7异二聚体的必要且充分条件，且异二聚体在体内的生物活性显著高于同源二聚体 [245]。

### 7.3 BMP2/BMP7双敲除

在肢芽间充质中（Prx1-Cre驱动），Bandyopadhyay等（2006）比较了Bmp2/Bmp7双敲与Bmp2/Bmp4双敲的表型 [241]：

- **Bmp2^C/+;Bmp7^null/null**：完全正常。
- **Bmp2^C/C;Bmp7^+/null**：仅表现Bmp2单敲的肩胛骨轻微缺陷。
- **Bmp2^C/C;Bmp7^null/null（双全敲）**：表型**远轻于**Bmp2/Bmp4双敲——前肢第III指末节指骨缺失，后肢腓骨畸形且与股骨膝关节无法 articulation，肩胛骨缺陷（与Bmp2单敲相同），附肢骨骼整体略小。但**软骨分化和骨分化均正常** [241]。

这表明在肢体骨骼发育中，BMP2/BMP4的组合比BMP2/BMP7更为关键，BMP7在肢体中的功能可部分被BMP4/BMP5/BMP6补偿。

### 7.4 BMP5/BMP7双敲除

Solloway和Robertson（1999）揭示了60A亚群（BMP5/6/7）内的功能冗余 [253]：

- **Bmp5⁻/⁻单敲**：存活，仅表现短耳畸形和轻微骨骼改变。
- **Bmp7⁻/⁻单敲**：出生后短期存活，肾脏和眼缺陷。
- **Bmp5⁻/⁻;Bmp7⁻/⁻双敲**：**E10.5胚胎致死**，表现严重的**尿囊发育缺陷、心脏异常、鳃弓畸形、体节缺陷和前脑发育受损**。这些组织正是Bmp5和Bmp7共表达的部位 [253]。

关键机制洞察：BMP5和BMP7不参与这些组织的模式形成，而是维持特定细胞群的增殖和存活。单敲时一方可补偿另一方，双敲则导致细胞增殖失败和凋亡增加 [253]。Bmp5/Bmp6双敲的胸骨骨化延迟也略有加剧，但远不如Bmp5/Bmp7双敲严重 [253]。

### 7.5 BMP9/BMP10双敲除

#### 7.5.1 全身性双敲除：高输出性心力衰竭

Bouvard等（2021）系统比较了Bmp9全身敲除、Bmp10条件性敲除（tamoxifen诱导）及双敲除（DKO）小鼠的表型 [229]：

**单敲表型**：
- **Bmp9⁻/⁻**：成年小鼠可存活，体重正常，无明显年龄相关表型。肺血管肌化轻度减少，血浆内皮素-1（ET-1）水平降低。慢性缺氧下，Bmp9⁻/⁻小鼠反而受到保护——右心室收缩压（RVSP）和肺动脉肌化程度显著低于野生型 [229]。
- **Bmp10-cKO**（成年诱导敲除）：成年小鼠可存活，心脏结构和功能正常。但慢性缺氧3周后出现**显著心脏肥大**，而肺血管重塑与野生型无差异 [229]。

**双敲表型（DKO）——进行性高输出性心力衰竭**：
- **存活与体重**：DKO小鼠成年后可存活，体重与野生型无显著差异 [229]。
- **心脏**：4月龄时心室扩张（左心室内径和容积在收缩期和舒张期均增加），每搏量和心输出量显著升高。11月龄时射血分数和短缩分数显著下降，发展为**扩张型心肌病伴高输出** [229]。
- **血浆标志物**：5月龄DKO小鼠血浆ANP和BNP水平显著高于单敲和野生型 [229]。
- **心肌细胞**：DKO小鼠心肌细胞个体显著增大，但无明显心肌纤维化 [229]。
- **血压**：DKO小鼠收缩压、舒张压和平均动脉压均显著低于野生型和单敲小鼠 [229]。
- **血管缺陷**：荧光微球实验证实DKO小鼠存在**体循环和肺循环动静脉分流**——45μm微球从左心室注射后异常通过至肺部，15μm微球静脉注射后异常通过至脑部。肺毛细血管平均面积增大2-3倍 [229]。
- **肺含铁血黄素沉积**：DKO小鼠肺部呈红褐色，普鲁士蓝染色显示含铁巨噬细胞浸润，提示慢性血管渗漏 [229]。
- **慢性缺氧反应**：DKO小鼠在慢性缺氧下，RVSP和肺动脉肌化的增幅低于野生型（与Bmp9⁻/⁻一致），但心脏肥大更为显著 [229]。

**机制**：BMP9和BMP10在常氧条件下对心血管稳态具有冗余作用，单敲无表型是因为另一方可补偿。双敲导致外周血管阻力下降（血管扩张+动静脉分流），继而引发高输出性心力衰竭。BMP9特异性调控肺血管张力（通过ET-1），BMP10特异性参与心脏重塑 [229]。

#### 7.5.2 BMP9/BMP10联合阻断与HHT模型

Ricard等（2012）首次证明BMP9和BMP10联合缺失导致出生后视网膜血管重塑异常，表现类似HHT的动静脉畸形（AVM） [251]。

Ruiz等（2016）开发了经哺乳传递的抗BMP9/10抗体阻断模型 [252]：
- **方法**：哺乳期母鼠腹腔注射抗BMP9/10抗体（15 mg/kg），抗体经乳汁传递至新生鼠血液循环。
- **视网膜表型**：P6新生鼠视网膜表现**血管过度增生（hypervascularization）、动静脉分化缺陷和多发大型AVM**。血管密度在毛细血管丛、动脉前沿和静脉前沿均显著增加。乳胶灌注实验证实动静脉直接分流存在 [252]。
- **分子机制**：RNA-Seq分析发现**血管生成素-2（Angpt2/ANG2）是最显著上调的基因**。ALK1-Fc处理HUVEC细胞同样上调ANG2，证实ALK1信号是ANG2的内源性抑制因子。BMP9/10阻断→ALK1信号抑制→ANG2去抑制→促血管生成→AVM形成 [252]。

Rajesh等（2024）进一步证明ACTRIIB-Fc或ALK1-Fc配体陷阱联合阻断BMP9/BMP10在易感小鼠中强烈模拟HHT表型 [248]，提示针对PAH的BMP9/10阻断疗法可能存在诱发AVM的风险。

Choi等（2022）则发现BMP10在动静脉网络发育中独立于BMP9发挥作用——Bmp10条件性敲除导致视网膜AVM，而Bmp9敲除则不表现此表型，提示BMP10是HHT病理中更相关的生理配体 [232]。

### 7.6 多基因敲除模型的总结与启示

| 基因组合 | 模型类型 | 关键表型 | 致死性 | 机制启示 |
|----------|----------|----------|--------|----------|
| Bmp2/Bmp4 | 全身杂合子互作 | 心脏流出道缺陷、腹壁闭合不全、眼异常 | 部分胚胎/出生后致死 | 共享功能，剂量阈值效应 [224, 237] |
| Bmp2/Bmp4 | 肢芽条件性双敲 | 极度肢体畸形，骨发生完全受阻（Osterix缺失） | 出生后存活但肢体严重畸形 | BMP2/4是成骨分化不可替代的配体 [241] |
| Bmp4/Bmp7 | 全身双杂合子 | 肋笼和远端肢体缺陷 | 存活 | 骨骼发育协同作用 [223] |
| Bmp4/Bmp7 | 尾部体复合突变 | Sirenomelia：后肢融合、膀胱缺失、肛门狭窄 | 胚胎/新生致死 | Bmp4为主配体，Bmp7加剧剂量不足 [227] |
| Bmp7^R-GF/Bmp2或Bmp4 | 异二聚体失活+杂合 | 腹壁闭合缺陷、心脏异常 | 胚胎致死 | BMP7主要通过异二聚体发挥作用 [222] |
| Bmp2/Bmp7 | 肢芽条件性双敲 | 指骨缺失、腓骨畸形（远轻于Bmp2/Bmp4双敲） | 存活 | BMP7在肢体中可被BMP4/5/6补偿 [241] |
| Bmp5/Bmp7 | 全身双敲 | 尿囊、心脏、鳃弓、体节、前脑缺陷 | E10.5致死 | 60A亚群功能冗余，维持细胞增殖 [253] |
| Bmp9/Bmp10 | 全身/条件性双敲 | 高输出性心衰、动静脉分流、肺含铁血黄素沉积 | 成年存活但进行性心衰 | 心血管稳态冗余，特异性分工 [229] |
| Bmp9/Bmp10 | 抗体联合阻断 | 视网膜AVM、血管过度增生、ANG2上调 | 新生期 | ALK1信号抑制→ANG2去抑制→AVM [252] |

**核心启示**：

1. **剂量阈值效应**：BMP信号存在严格的剂量阈值。单基因杂合子往往表型正常，但双杂合子因总BMP信号量跌破阈值而出现缺陷，这在Bmp2/Bmp4和Bmp4/Bmp7组合中尤为明显 [224, 223]。

2. **异二聚体是体内主要功能形式**：BMP7^R-GFlag突变体的表型远比常规敲除严重，且与Bmp2或Bmp4杂合后即致死，直接证明BMP7在哺乳动物胚胎发育中主要通过BMP2/7和BMP4/7异二聚体发挥作用 [222]。这解释了为何不同BMP基因突变导致重叠的先天缺陷谱。

3. **功能冗余与特异性并存**：BMP9/BMP10在常氧下完全冗余（单敲无表型），但双敲导致灾难性心血管表型；而在慢性缺氧下，BMP9特异性调控肺血管重塑，BMP10特异性参与心脏重塑 [229]。这种"冗余兜底+特异分工"的模式可能是BMP家族的普遍特征。

4. **骨发生对BMP2/4的绝对依赖**：在肢体中，BMP2/BMP4联合缺失导致骨发生完全受阻（Osterix无法表达），但软骨发生仍可进行，揭示了一条BMP2/4特异的成骨细胞分化调控通路 [241]。

5. **BMP9/10阻断的AVM风险**：联合阻断BMP9/BMP10（无论是基因敲除还是配体陷阱）均可诱发HHT样血管畸形，这对正在开发的BMP9/10靶向PAH疗法构成了安全性警示 [252, 248]。
...
BMP通路小分子抑制剂主要靶向I型受体的激酶结构域，阻止R-SMAD磷酸化 [76, 78]：

| 抑制剂 | 主要靶点 | 选择性 | 临床应用方向 |
|--------|---------|--------|-------------|
| **Dorsomorphin（Compound C）** | ALK2/3 | 差——抑制大量其他激酶 | 不推荐作为BMP选择性抑制剂 [79] |
| **LDN-193189** | ALK2/3 | 高效但选择性仍有限——BMP抑制浓度下抑制多种其他激酶 | FOP、血管钙化（临床前）[79] |
| **LDN-212854** | ALK2 | 对ALK2选择性提高 | FOP模板药物 [71] |
| **DMH1** | ALK2 | 与LDN-193189不同的选择性谱 | 神经分化研究 [77] |
| **K02288** | BMP I型受体 | 较广谱 | 发育生物学研究 |

**注意事项**：
- Dorsomorphin和LDN-193189还可通过结合ActRIIA受体和ALK4抑制肌生成抑制素（GDF8）信号，脱靶促进肌母细胞分化 [80]。
- LDN-193189在小鼠模型中显著增强骨转移发展，强调在骨转移管理中需谨慎选择药物 [75]。
- LDN-193189可影响骨髓基质细胞命运但不能阻止软骨发生中的肥大化 [72]。

### 8.2 蛋白拮抗剂

| 拮抗剂 | 主要结合配体 | 功能特征 |
|--------|-------------|---------|
| **Noggin** | BMP2、BMP4、BMP7 | 与BMP2以1:1形成高亲和力复合物（KD ≈ 0.4 nM）[68] |
| **Chordin** | BMP2、BMP4 | 与BMP和Noggin形成形态发生通路网络 [69] |
| **Follistatin** | 激活素、BMP | 结合亲和力和功能效力差异塑造信号强度和范围 [67] |
| **Gremlin** | BMP2、BMP4、BMP7 | 选择性调节BMP依赖的类固醇生成 [60] |
| **USAG-1** | BMP7 | 肾脏中BMP7信号的负调控因子 [126] |
| **Crossveinless-2** | BMP9、BMP10 | 血管生物学中的BMP信号调节 |

BMP拮抗剂通过结合亲和力、局部浓度梯度和基质螯合的精密调控来调节BMP信号强度，在发育和疾病中发挥关键作用 [66]。Chordin/BMP梯度通过相互作用和差异扩散网络实现稳健的背化 [69]。
...
- **机制**：选择性RARγ激动剂，通过抑制BMP/SMAD信号减少异位骨化 [136, 137]。
- **FDA批准**：2023年8月16日获FDA批准（NDA 215559），商品名Sohonos，是FOP的首个且唯一获批治疗药物 [198, 200]。适应症为减少成人和儿科患者（女性≥8岁，男性≥10岁）FOP中的新异位骨化体积 [199]。
- **给药方案**：成人和≥14岁儿科患者慢性给药5 mg/日；急性发作给药20 mg/日×4周，随后10 mg/日×8周（共12周）；<14岁儿科患者按体重调整 [199]。
- **临床效果**：III期MOVE试验（开放标签，107例患者，占全球FOP患者约12%）显示palovarotene有效减少年化异位骨化体积（与自然史研究相比降低54%，加权线性混合效应模型）[129, 200]。II期随机安慰剂对照试验也显示预防异位骨化的潜力 [130]。
- **安全性**：最常见不良事件为皮肤黏膜事件（干皮、唇炎、脱发、药疹、瘙痒）和肌肉骨骼事件（关节痛、生长中儿童的过早生长板闭合）[200]。生长板闭合是骨骼未成熟患者的主要风险 [129]。
- **监管历程**：2022年12月FDA首次发出完全回复函（拒绝）；2023年3月Ipsen提交新分析；2023年6月FDA咨询委员会支持批准；2023年8月正式批准 [202]。欧盟于2023年7月拒绝上市许可 [203]。加拿大于2022年1月首次批准 [136]。
- **定价**：美国标价约624,000美元/年 [202]。

**其他FOP在研药物**：
- **Garetosmab**：抗激活素A抗体，在FOP中显示潜力但面临安全性挑战 [133]。
- **ALK2选择性抑制剂**：基于LDN-212854结构设计的ALK2选择性抑制剂正在开发中 [71]。

#### 7.3.2 贫血/铁代谢

BMP9/铁调素轴是贫血治疗的重要靶点：
- BMP信号阻断可降低铁调素、增加铁可用性，为铁调素过载相关贫血提供治疗策略 [94, 100]。
- 可溶性血幼素（HJV.Fc）通过阻断BMP诱导的铁调素增加膜铁转运蛋白和血清铁 [100]。

#### 7.3.3 肺动脉高压（PAH）

- **Sotatercept（Winrevair）**：2024年3月获FDA批准，通过重新平衡ActRIIA/BMPRII信号治疗PAH [183, 188]。但最新研究表明其可能通过耗竭循环BMP9和BMP10导致BMP信号减少 [180]。
- **BMP9/BMP10增强策略**：GDF2突变导致BMP9/BMP10水平降低，支持增强BMP9/BMP10信号的治疗策略 [115]。

#### 7.3.4 癌症

- BMP9-ID1信号促进肝细胞癌肿瘤干细胞特性，靶向该通路可能提供新治疗选择 [74]。
- BMP9在乳腺癌中作为肿瘤生长和转移的静息因子，激活BMP9通路可能是肿瘤血管正常化的新策略 [111]。
- BMP信号抑制剂LDN-193189在小鼠中增强骨转移，提示需谨慎 [75]。

#### 7.3.5 血管钙化

BMP信号在血管钙化中发挥复杂多样的调节作用，具有治疗意义 [123]。
...
7. **异源二聚体**（如BMP2/7、BMP4/7）在超低剂量下即可实现与高剂量同源二聚体相当的疗效，是降低副作用的重要策略 [3, 145]。
