...
**免疫调节**：BMP2的成骨效应依赖于局部微环境中巨噬细胞-间充质干细胞的相互作用，可通过引入免疫调节策略优化 [15]。

**BMPR2受体**：BMP2的主要II型受体BMPR2在胚胎发育、血管发生和骨发生中发挥多样化作用，其基因改变与肺动脉高压、肿瘤和代谢疾病相关 [16]。

### 2.2 基因敲除动物表型

**Bmp2完全敲除小鼠**：Bmp2基因敲除小鼠在胚胎期死亡，主要表现为心脏垫EMT失败和AV管心肌模式形成紊乱，导致严重的心脏发育缺陷 [27]。此外，胎盘发育缺陷在胚胎致死小鼠中高度普遍，影响脑、心脏和血管发育 [23]。

**心脏特异性表型**：
- Bmp2在心肌中过表达会导致异位EMT、促进心肌细胞增殖但损害心室成熟和模式形成，导致E15.5前胚胎死亡 [22]。
- BMP2单倍体不足（haploinsufficiency）可能与孤立性右位心（dextrocardia situs solitus）相关，表现为身材矮小、听力受损和轻微骨骼畸形 [21]。

**BMPR2突变**：BMPR2突变是遗传性肺动脉高压（PAH）的主要致病基因。在先天性心脏病相关PAH中，BMPR2突变通过调控ID1和ID3基因影响心肌细胞功能 [25]。
...
**Noggin**：Noggin是BMP2最典型的胞外拮抗剂，以1:1化学计量比与BMP2形成高亲和力非共价复合物（KD ≈ 0.4 nM），通过空间位阻阻止BMP2与受体结合 [68]。Noggin阻断BMP2信号可抑制软骨发生。

**小分子抑制剂**：
- **Dorsomorphin（Compound C）**：首个被鉴定的BMP通路小分子抑制剂，但选择性差，除抑制ALK2/3外还抑制大量其他激酶，不推荐作为BMP选择性抑制剂 [79]。
- **LDN-193189**：dorsomorphin的优化衍生物，对ALK2/3具有高效抑制活性，但在BMP抑制浓度下也抑制多种其他激酶，选择性仍有限 [79]。LDN-193189可影响骨髓基质细胞命运，但不能阻止软骨发生过程中的肥大化 [72]。值得注意的是，LDN-193189在小鼠模型中显著促进骨转移的发展，提示在骨转移管理中需谨慎选择药物 [75]。
- **LDN-212854**：对ALK2具有更高选择性的抑制剂，为治疗FOP和相关疾病提供了模板 [71]。
- **DMH1**：通过结合位点残基和配体结构的微小变化实现与LDN-193189不同的选择性谱 [77]。

#### 2.3.3 正面影响（治疗潜力）

BMP2信号阻断在以下场景中具有治疗潜力：
- **异位骨化（HO）**：在FOP等疾病中，过度BMP信号导致软组织骨化，阻断BMP信号可减少异位骨形成（详见第七章palovarotene部分）。
- **骨关节炎**：BMP2信号通路在骨发生和骨关节炎中的双重角色表明，靶向BMP2信号可能为更安全的再生治疗提供路径 [17]。
- **肺纤维化**：BMP4过表达可抑制肺纤维化（见BMP4部分），提示BMP信号的精细调控而非完全阻断可能更有治疗价值。

#### 2.3.4 负面影响（副作用/毒性）

- **胚胎致死**：Bmp2完全敲除导致胚胎死亡，表明BMP2信号对胚胎发育至关重要。
- **骨转移风险**：LDN-193189作为BMP通路抑制剂在小鼠模型中显著增强骨转移发展 [75]。
- **抗BMP2抗体**：在INFUSE临床试验中，0.7%的rhBMP-2治疗患者产生抗rhBMP-2抗体，理论上可能影响胎儿发育 [206]。
- **肌肉损失场景中的剂量效应**：在伴有肌肉损失的复合骨缺损模型中，BMP-2剂量增加（至10 μg）可改善骨再生而不引起异位骨化或全身炎症 [147]。

### 2.4 动物模型及给药方案

BMP2的动物模型和给药方案在骨再生研究中已得到广泛验证，涵盖从啮齿类到非人灵长类的多种物种 [138]：
