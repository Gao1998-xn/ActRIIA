...
**骨/软骨形成**：BMP2通过激活经典SMAD1/5/8通路和非经典MAPK通路（ERK、p38、JNK），上调Runx2等成骨转录因子，促进间充质干细胞（MSC）向成骨细胞分化和骨形成<a href="#ref-17，18">[17，28]</a>。BMP2的成骨效应呈剂量依赖性，且与机械力传导协同作用——BMP2信号和机械力通过YAP/TAZ作为"分子记忆单元"协同驱动成骨分化<a href="#ref-12">[12]</a>。在颅面骨发生中，BMP2促进干细胞分化和SMAD信号传导，对颅面缺损修复具有治疗潜力<a href="#ref-13">[13]</a>。

**心脏发育**：BMP2在心脏发育中不可或缺。它在房室（AV）管区表达，对AV心内膜垫的上皮-间质转化（EMT）和心肌模式形成至关重要<a href="#ref-27">[27]</a>。BMP2在内膜谱系中的表达对于AV心内膜垫成熟和重塑为正常膜性室间隔和分层房室瓣是必需的 [24]。BMP2/4在心脏中以剂量依赖方式调控Hand1表达，影响心脏流出道发育<a href="#ref-29I">[29]</a>。
...
- **LDN-193189**：dorsomorphin的优化衍生物，对ALK2/3具有高效抑制活性，但在BMP抑制浓度下也抑制多种其他激酶，选择性仍有限<a href="#ref-79">[79]</a>。LDN-193189可影响骨髓基质细胞命运，但不能阻止软骨发生过程中的肥大化<a href="#ref-72">[72]</a>。值得注意的是，LDN-193189在小鼠模型中显著促进骨转移的发展，提示在骨转移管理中需谨慎选择药物<a href="#ref-75">[75]</a>。
...
**临床效果**：
- **融合率**：系统综述显示rhBMP-2显著提高ALIF融合率（97.8% vs 88.2%）和PLF融合率（93.6% vs 83.1%），ALIF融合OR约7.08，PLF融合OR约3.06，但PLIF/TLIF融合率无显著改善<a href="#ref-160">[160]</a>。剂量-效应荟萃分析显示ALIF中BMP使融合率提高至96.9%（对照组79.1%，p<0.01），PLF在≥8.5 mg/节段时融合率95.2%（对照组75.3%，p<0.05）<a href="#ref-155">[155]</a>。。
...
**成本与替代**：Map3细胞同种异体骨移植物在ALIF中显示与rhBMP-2等效的融合率，但成本更低<a href="#ref-152">[152]</a>。INFUSE和InductOs在骨再生方面有前景，但在成本、力学性能和可控生长因子递送方面仍需创新<a href="#ref-151">[151]</a>。
...
**眼发育**：BMP4对小鼠胚胎晶状体诱导至关重要——Bmp4敲除完全废除晶状体诱导，可通过在视泡施加BMP4蛋白挽救<a href="#ref-47">[47]</a>。BMP4信号是JNK驱动的细胞因子级联的一部分，诱导Pax2表达和视裂闭合<a href="#ref-45">[45]</a>。
...
**生殖系统**：BMP4通过SMAD依赖和非依赖通路抑制大鼠干细胞/祖Leydig细胞发育和再生<a href="#ref-51">[51]</a>。在卵巢中，BMP4在卵泡发育、多囊卵巢综合征（PCOS）和卵巢癌中发挥重要作用<a href="#ref-53">[53]</a>。
...
BMP4信号可被多种胞外拮抗剂阻断：
- **Noggin、Chordin、Follistatin、Gremlin**：这些胞外结合蛋白选择性调节BMP依赖的卵巢类固醇生成变化<a href="#ref-60">[60]</a>。BMP拮抗剂通过结合亲和力、局部浓度梯度和基质螯合的精密调控来调节BMP信号强度<a href="#ref-66">[66]</a>。
...
- **Bmp2⁺/⁻;Bmp4⁺/⁻双杂合子**：存活率显著低于孟德尔预期，部分胚胎出现心脏流出道分隔缺陷、腹侧体壁闭合不全及眼发育异常。单杂合子（Bmp2⁺/⁻或Bmp4⁺/⁻）表型基本正常，表明两者在多个器官发育中共享功能，且存在剂量阈值效应<a href="#ref-224">[224]</a>]。
...
这些结果解释了为何BMP4和BMP7突变在人类中导致相似的先天缺陷谱——因为它们在体内主要以BMP4/7异二聚体形式共同发挥作用<a href="#ref-222">[222]</a>。共免疫沉淀实验进一步证实了内源性BMP4/7异二聚体的存在 <a href="#ref-222">[222]</a>。
...
关键机制洞察：BMP5和BMP7不参与这些组织的模式形成，而是维持特定细胞群的增殖和存活。单敲时一方可补偿另一方，双敲则导致细胞增殖失败和凋亡增加<a href="#ref-253">[253]</a>。Bmp5/Bmp6双敲的胸骨骨化延迟也略有加剧，但远不如Bmp5/Bmp7双敲严重 <a href="#ref-253">[253]</a>。
...
BMP拮抗剂通过结合亲和力、局部浓度梯度和基质螯合的精密调控来调节BMP信号强度，在发育和疾病中发挥关键作用 <a href="#ref-66">[66]</a> 。Chordin/BMP梯度通过相互作用和差异扩散网络实现稳健的背化 <a href="#ref-69">[69]</a> 。
...
- **定价**：美国标价约624,000美元/年<a href="#ref-202">[202]</a>。
